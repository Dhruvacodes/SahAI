...
If demoing to judges:

1. **Open app**: "This is SahAI, an AI co-pilot for ASHA workers"
2. **Show language selection**: "Languages in native script - hindi, tamil, telugu..."
3. **Select हिंदी** → Home screen
4. **Tap "New Visit"** → Select "सुनीता देवी" (critical-risk patient)
5. **Record voice**: "सुनीता का BP 165/110 है, सूजन है, बच्चे की हरकत नहीं 2 दिन से"
6. **Show Risk Score**: "Sistema detected CRITICAL risk automatically. No doctor needed to interpret."
7. **Show extracted vitals**: "BP 165/110, oedema present, absent fetal movements"
8. **Show recommended action**: "Immediate emergency referral required"
9. **Switch to Dashboard**: "ANM supervisor sees this automatically when visits sync"
...
2. Run: `expo doctor` (checks environment)
3. Clear cache: `expo cache clean`
...
- [ ] Demo patients loaded in database
- [ ] Test recording works end-to-end

---

**Happy demoing! SahAI is ready to serve India's health workers.** 🌾
